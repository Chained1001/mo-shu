...
> **最近更新（v2.6.1）**：外部经验吸收——C20 工序精化六项（先大后小禁忌/章末走到状态锚/信息差进攻性用法/卷篇幅配比[非书证]/支线挂靠三分法/建纲心流四阶段[限设计侧]）+ C21 原料扩展三项（采风五类扩七类：人物原型+时代质感[乌贼实证]/隔夜冷修时点）+ C22 正文参数三项（爽点密度缺省[无书证可覆盖]/铺垫质量三问/熟悉意外配比）+ 盲区 #16 退出码纪律；agents_version 47
...
│   ├── 关系.md          # 角色关系映射
│   ├── 题材定位.md      # 题材核心梗+对标分析+终局底牌+成品标尺节（节奏/情绪/结构三组目标态，B94 起）
