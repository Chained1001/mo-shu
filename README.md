...
> **最近更新（v1.1.0）**：三项目方法论补完（笔枢/引火/V7 的 P0/P1 改造计划全部落地——反 AI 10 条硬约束、章后对照、命名卡/场景卡/技法卡、事实查证纪律）+ 拆文/扫榜确定性工程化（标准章节解析与硬检查脚本、检查点机制、多榜单一次采集）+ 部署一键化。更早版本变更见 [CHANGELOG.md](CHANGELOG.md)。
