...
printf '{"schema_version":7,"state_revision":0,"last_committed_chapter":1}\n' > "$cont_root/book/追踪/_tracking-state.json"
...
# 负向：追踪跟上 + 标题不重复不报
printf '{"schema_version":7,"state_revision":0,"last_committed_chapter":2}\n' > "$cont_root/book/追踪/_tracking-state.json"
...
printf '{"schema_version":7,"state_revision":0,"last_committed_chapter":200}\n' > "$guard_root/book/追踪/_tracking-state.json"
