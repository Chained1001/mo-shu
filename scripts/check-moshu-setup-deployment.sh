...
assert_grep '本轮 K（最多 3 章）后必须进入 Stage 4-3/4-4 收尾并停止|最多 3 章.*收尾并停止' "$REPO_ROOT/skills/moshu-write/references/workflow-daily.md" "daily workflow must stop after bounded batch"
