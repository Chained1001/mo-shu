...
assert_grep 'repair_action.*Stage 3|Stage 3.*repair_action|重跑 /moshu-analyze Stage 3' "$SKILL_DIR/references/templates/agents/story-explorer.md" "story-explorer must provide a repair action instead of silent fallback"
