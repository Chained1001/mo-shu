...
description: |
  ...
  被 story-long-write（Phase 4-5）调用。
  也可执行完整去AI味流程和格式合规检查。
...
- **Gate C 心理描写外化**：默认情绪词 -> 身体状态（`story-setup/references/agent-references/anti-ai-writing.md` Show Don't Tell），一处到位即可，别为外化堆蹭袖口、攥裤管一类无功能小动作。
