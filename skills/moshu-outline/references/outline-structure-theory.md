...
方法论出处注记（B68）：场景-续景交替（Swain《Techniques of the Selling Writer》：场景[目标/冲突/挫折]→续景[反应/困境/决定]）与价值转变（McKee《故事》：无价值正负转变的场景删）是场景表与一进一出自检的理论锚；密 / 疏配比即 Genette 时距（场景=密、概述=疏）的叙事学标注——出处入注记不开新节。
