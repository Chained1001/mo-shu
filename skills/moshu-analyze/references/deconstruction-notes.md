...
| 素材转化 | Stage 0-6（全流程）| 拆文结果转化为写作指导 |
...
流程（单主对标架构）：扫榜收集同题材市场样本（moshu-scan 选题决策）→ 拆书 Phase 1 按题材推荐 2-3 本候选 → 用户选定 **1 本主对标**（情绪/节奏/正文权威）→ 登记 `设定/题材定位.md` 主对标书；无对标合法（理论 references + 八节点自排）
