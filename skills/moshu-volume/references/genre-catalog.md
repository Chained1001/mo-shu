...
> **用途**：写大纲（build 轮 1 题材初判）与拆文（analyze Stage 1 框架标注）时对照使用，亦是采风前置查库的分流尺（B71）。你是一个熟练的网文结构分析师，按照下方路由表选择对应框架，严格执行结构比例和情绪节拍。

> **消费点（B103 刷）**：2 立意表单按需（题材路由）/4.1 按需
---
...
| 对应题材写作公式 | genre-writing-formulas.md（write 侧） |
