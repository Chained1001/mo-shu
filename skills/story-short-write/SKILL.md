...
- [ ] `node scripts/check-outline-copy.js 正文.md` 无未授权誊抄（正文与 小节大纲.md 连续重合 >15 字需逐条复核；复沓锚句除外）
...
| [scripts/check-outline-copy.js](scripts/check-outline-copy.js) | Phase 3 完成门槛与 Phase 4 复扫；检测正文照搬 小节大纲.md（>15 字连续重合），只报告不改写 |
