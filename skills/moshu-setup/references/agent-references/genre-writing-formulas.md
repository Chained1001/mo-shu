...
> **定位（2026-08-24 降级）**：本公式系 mo-shu 自定（无书证）；**离线兜底的短篇/开篇弧/单元内节奏参考**——优先用 /moshu-research 采风获取当前热门作品的活结构，无采风产物时才用本公式。**禁止直接套用为长篇卷结构**（配方为 18-19 章短篇尺寸，长篇以步 1 骨架表六要素+势力场设计为准）；反派推进模式与势力场设计冲突时，以势力场设计为准。
