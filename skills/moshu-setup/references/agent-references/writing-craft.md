...
| 你在写什么 / 卡在哪 | 加载文件与节 |
|---|---|
| 对话 / 台词 | dialogue-mastery.md（核心规则/权力博弈/潜台词/语言差异化/群众对话）+ 本文件「对话中的权力博弈」 |
| 打斗 / 装逼 / 爽点释放 | style-combat-face.md（爽点释放到位法则/装逼打脸框架/二级装逼技法） |
...
> 使用顺序建议：**先结构（钩子/悬念/场景）→ 再血肉（对话/打斗/情绪）→ 后质检（去 AI 味/格式）**。卡在哪一步就加载对应行。
...
### 黄金三章 = 定调与预期管理
验证"实物是否与图片一致"，快速回应读者期待。公式：令人不安的处境 + 亟待提升的地位 + 充满希望的外挂 + 能被展望的美好未来。
...
3. **围绕核心情绪设计全部情节**：动笔前确定目标读者的核心情绪需求（被认可/复仇/恋爱/升级），所有情节、人设、冲突都围绕这根弦
4. **宏观微观一体把控**：宏观把控整体节奏和情绪走向，微观把控每段文字的细节和张力
