...
每本书配一句核心梗定调句（≤50 字）：用**书中的专有名词**，说清"这本书的独特吸引力是什么"，具体不空泛。它是开书「一句话梗概」的表达标准，也是写手每次回忆核心卖点时的锚点——写手拿不准"这章该往哪使劲"时先读这句。

- 好的例子：「一个无脉少年问鼎规则的复仇，比任何阴谋都更冷、更有来由。」
- 坏的例子：「这是一个关于复仇和成长的故事。」——可整体换到任意同类书，没有专有名词，不锚定本书。
- 自检：这句能否原样换到别的书还成立？能 → 不够具体，重写。
