...
- **章首/章尾钩子**：本文件决策路由 + 章尾 14 式 / 章首 7 式 / 实战模板
- **段落级钩子（微张力）**：本文件「段落级钩子（微张力·段落级悬念，B91）」节
- **悬念/连续悬念**：hooks-suspense（独立文件，不动）
...
| 愿望/成长/团圆前夜 | 渴望钩（好事条件已齐、只差临门一脚时截断）| 期待兑现；可叠阻碍阴影但不拆渴望，勿狼来了 |
...
| 14 | 渴望钩 | 角色内心愿望临近兑现，在实现前一刻截断（与承诺/威胁的区别：那是外界行动预告，这是角色愿望临门）| "他攒了三年钱，终于够买下那间铺子。房主说：明天来签合同。" |
...
## 段落级钩子（微张力·段落级悬念，B91）
段落级钩子类型、组合技法、禁忌、对话情绪递增、不公平伤害、围观者层级。用于段落内微钩子设计。

---

## 微张力（段落级悬念，B91）

> 唐纳德·马斯命名——**追读力的毛细血管层**：读者停下的理由不是大情节，而是**每段末脑子里挂着的那个问号**。

- **原理**：读者停在开放问题上，不是停在悬念的大情节上——大情节钩子管「翻下一章」，微张力管「不停下滑」。
- **操作**：每段末留一个未答问题/未完动作/新疑点（一个就够）——段间过渡段也必须有一个微型开口，纯交代的段落压缩或合并。
- **与章级钩子分层（禁合并）**：章尾钩（hooks-chapter）管「翻下一章」；微张力管「不停下滑」——两套并存，微张力是段落层、章尾钩是章层，不互相替代。
- **检查问句**：这段结束时读者脑子里挂着一个问号吗？没有=纯过渡，压缩或加钩。
