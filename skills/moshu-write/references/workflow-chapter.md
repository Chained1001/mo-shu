...
8. **第 3 遍·技艺打磨（技艺帽）** → core「第 3 遍·技艺打磨」（五磨+修剪+字数验收）——微张力与章级钩子按需加载 [hooks-paragraph.md](hooks-paragraph.md)/[hooks-chapter.md](hooks-chapter.md)（微张力管段间不停滑，章尾钩管翻章）
...
- **第一章专项（B91→B94 接线修复）**：本章为第 1 章首写时——**多版本开头**（2-3 版 300 字级，悬念/画面/对话切入，作者选一版续写；「直接写」跳过）+ **前 300 字打磨**（第一句三秒抓人/前 100 字画面/前 300 字知主角要什么）；日更续写跳过（B94 自 daily 移入）。
