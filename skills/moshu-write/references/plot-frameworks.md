...
> 本节内容与 [plot-emotion-system.md](plot-emotion-system.md)「提炼层级」重复（三层抽象/戏剧单元/情绪模块/重构与微调用法），已收敛至该处——此处不再重复维护。
...
> 本节内容与 [outline-rhythm.md](outline-rhythm.md)「桥段的标准四章结构」重复（长篇桥段拆分/单桥段四章结构），已收敛至该处——此处不再重复维护。

## 故事本质与六幕结构

> 本节内容与 [outline-structure-theory.md](outline-structure-theory.md)「三幕式与五幕式」重复（故事定义/因果链/四法组织事件/五幕式/三幕四幕五幕统一论/第六幕余波/转折核心），已收敛至该处——此处不再重复维护。framework 侧仅保留以下两段独有内容：
...
> **苏式问（冲突设计前必答）**：主角此刻最不想面对的事是什么？谁在逼他面对？如果他可以选择逃避，故事还有什么张力？——答不出「非踏入不可」的强迫性理由，说明冲突还没建立，按下方核心公式与「有进无出」原则重做。
...
> **苏式问（全局自检）**：你的故事崩在哪一条——如果一条都没崩，为什么读者还是弃书了？五不崩是底线不是卖点——底线全过但留不住人，说明缺的是超越底线的吸引力，回到「核心梗与细化法」找卖点。
...
> 全局不崩检查（五不崩）见正文「千均写作指南：作品五不崩」——此处不重复。
