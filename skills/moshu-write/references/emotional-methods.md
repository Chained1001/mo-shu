...
**案例**：
- 某篇：用二十年的账本数字（八万块）建立母女关系的重量
- 某篇：昏迷五年、求神拜佛的细节、从初中开始的暗恋
- 某篇：七年质子生涯的具体苦难（跪雪地、挨巴掌、吃馊饭）
...
**案例**：
- 某篇：妈妈表面软弱可怜，实际一直操控姐姐索取钱财 → 金锁是假的（金包铜）→ 反差撕裂
- 某篇：王氏表面温柔（送手炉、煎汤药）→ 实际下药逼疯先皇后 → 用诛心话逼死
- 某篇：弟弟深爱女友 → 女友是诈骗犯 → 怀孕是假的 → 被骗到电诈园区
...
**案例**：
- 某篇：「他拿着那匹被我磨得很光滑的木头小马……他握着正好。」
- 某篇：「我的手机清净了不少。那些困扰我很久的麻烦，在一瞬间变得很小很小。」
- 某篇：「办了收养手续后，她第一次踏进这个陌生的家……我知道，这一次我没选错。」
...
1. **情绪转向频率是题材与篇幅经验法则**：结合题材、篇幅和既有兑现节奏调整，不固定要求每 3-5 章转向
...
- 情绪反弹速度：快（受辱后 2-3 章内打脸）
- 打脸密度：每 3-5 章一次
- 反派嚣张度：递增（第一次小嚣张，最后一次大嚣张）
- 结尾基调：痛快、解气
- 案例：某篇— 打分制反制、铁盒零分、断绝关系
...
| 失败模式 | 识别方法 | 修正方向 |
|----------|----------|----------|
| **太平** | 连续 5+ 章没有情绪转折 | 插入意外事件或新信息 |
| **太赶** | 重大转折缺少可辨认的铺垫 | 按转折重量与篇幅给予足够且可辨认的铺垫，不固定三章 |
...
## 规定情境代入与任务动词化（B78，演员自我修养苏格拉底化）

**规定情境代入**：情绪不由细纲直接命令（「此处愤怒」），由**规定情境四要素导出**——处境（TA 在哪/失去什么）/时限（还有多久）/谁知道什么（信息差）/关系压力（谁在场）——四要素恰好是 write 侧点名清单现成字段：写正文前按四要素自查，情绪导不出来=情境要素缺项，回补细纲而非硬写。

**任务动词化**：细纲目标从名词改动词（「报仇」→「让他当众失去一切」）——动词化后的目标可直接转成场景动作，角色每场戏有一个可执行的动词任务。
