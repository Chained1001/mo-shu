...
长篇连载更吃这四条，因为读者要追几十万字，安全感断一次就掉追读。
...
长篇简介多一个任务：除了抓人，还要让读者相信这本能追下去。基本五种类型见 [genre-readers.md](genre-readers.md)，本节是女频专用的**安全感导向组合**。
...
长篇选题第一关：题材要有**长线骨架**——能撑几十万字的主线，不是一个梗写完就没了。一个反转、一次打脸的梗不够撑长篇。
